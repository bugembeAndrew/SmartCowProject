...
import com.smartcowprojekt.smartcow.adapter.FarmListAdapter;
...
public class FarmList extends AppCompatActivity {

    // Log tag
    private static final String TAG = FarmList.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FarmListAdapter(this, farms);
        ...
        StringRequest farmReq = new StringRequest(AppConfig.ALL_FARMS_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            JSONArray farmArray = objekt.getJSONArray("farm");
                            for(int j = 0; j < farmArray.length(); j++){
                                JSONObject obj = farmArray.getJSONObject(j);
                                Farm farm =
                                        new Farm(obj.getInt("farm_id"),
        ...
        AppController.getInstance().addToRequestQueue(farmReq);
    }
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(FarmList.this, Login.class);
